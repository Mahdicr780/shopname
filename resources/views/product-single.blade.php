                                    ...
                                    <div class="parent-btn">
                                        <form action="{{ route('cart.store') }}" method="POST">
                                           ...
                                           <input type="submit" value=" افزودن به سبد خرید">
                                            ...
                                            <input type="number" name="quantity" class="form-control" min="1" max="{{ $product->amount }}">
                                        </form>
                                    </div>
                                </div>
                            </div>
                                                                ...
                                                                <div class="comment-body">
                                                                    <div class="comment-author">
                                                                        <img alt=""
                                                                            ...
                                                                            class="avatar"><cite class="fn">{{ $comment->user->name }}</cite>
                                        ...
                                        <div class="tab-pane form-comment" id="questions" role="tabpanel"
                                            ...
                                            <article>
                                                ...
                                                <form action="{{ route('send.comment') }}" method="POST"
                                                    class="comment">
                                                    @csrf
                                                    <input type="hidden" name="commenttable_id"
                                                        value="{{ $product->id }}">
                                                    <input type="hidden" name="commenttable_type"
