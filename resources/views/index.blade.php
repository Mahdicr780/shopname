    ...
    <div class="row">
        <aside class="sidebar col-12 col-lg-3 order-2 order-lg-1">
            <div class="sidebar-inner default">
                ...
                <div class="widget-suggestion widget card">
                    ...
                    <div id="suggestion-slider" class="owl-carousel owl-theme">
                        ...
                        <div class="item">
                            ...
                            <h3 class="product-title">
                                <a href="#"> لپ تاپ ۱۳ اینچی اپل مدل MacBook Pro MLH12 همراه با تاچ
                                    بار
                                </a>
                            </h3>
                            <div class="price">
                ...
                <div class="widget-banner widget card">
                    <a href="#" target="_top">
                        <img class="img-fluid" src="assets/img/banner/1000001322.jpg" alt="">
                    </a>
                </div>
                <div class="widget-banner widget card">
                    <a href="#" target="_blank">
                        <img class="img-fluid" src="assets/img/banner/1000001442.jpg" alt="">
                    </a>
                </div>
                <div class="widget-banner widget card">
                    <a href="#" target="_blank">
                            ...
                            <div class="row m-0">
                                ...
                                <div class="left-col col-7">
                                    ...
                                    <h2 class="product-title">
                                        <a href="#"> لپ تاپ ۱۱٫۶ اینچی دل مدل INSPIRON 3168 -AC B
                                        </a>
                                    </h2>
                                    <ul class="list-group">
