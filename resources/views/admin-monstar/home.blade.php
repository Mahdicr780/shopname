                        ...
                        <div class="card-body px-3 py-2">
                            <div
                                ...
                                <ul
                                    ...
                                    <li><a href="#" class="btn"><i class="ti-arrow-down"></i>
                                            بارگیری ها</a></li>
                                    <li><a href="#" class="btn"><i class="ti-reload"></i> به
                                            روزرسانی ها</a></li>
                                    <li><a href="#" class="btn"><i class="ti-import"></i> وارد
                                            كردن</a></li>
                                </ul>
                                <ul
                                    class="sales-reports d-flex align-items-center justify-content-between">
            ...
            <div class="row">
                            ...
                            <div class="dashboard-tab-area">
                                ...
                                <div class="bd-example bd-example-tabs">
                                    <div class="tab-content" id="tabContent-pills">
                                        ...
                                        <div class="tab-pane fade active show" id="earnings-sun"
                                            role="tabpanel" aria-labelledby="pills-earnings-sun">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                    ...
                                    <ul class="nav nav-pills align-items-center" id="pills-tab"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active show" id="pills-earnings-sat"
                                                ...
                                                aria-selected="false">نشسته</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link show" id="pills-earnings-sun"
                                                data-toggle="pill" href="#earnings-sun" role="tab"
                                                aria-controls="earnings-sun"
                                                aria-selected="true">آفتاب</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-earnings-mon"
                                                data-toggle="pill" href="#earnings-mon" role="tab"
                                                aria-controls="earnings-mon"
                                                aria-selected="false">دوشنبه</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link show" id="pills-earnings-tue"
                                                data-toggle="pill" href="#earnings-tue" role="tab"
                                                aria-controls="earnings-tue" aria-selected="false">سه
                                                شنبه</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link show" id="pills-earnings-wed"
                                                data-toggle="pill" href="#earnings-wed" role="tab"
                                                aria-controls="earnings-wed"
                                                aria-selected="false">چهارشنبه</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link show" id="pills-earnings-thu"
                                                data-toggle="pill" href="#earnings-thu" role="tab"
                                                aria-controls="earnings-thu"
                                                aria-selected="false">پنجشنبه</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link show" id="pills-earnings-fri"
                                                data-toggle="pill" href="#earnings-fri" role="tab"
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="dashboard-content-right">
                                    ...
                                    <p class="font-15 font-weight-bold">شما امروز 65.6٪ <br>فروش بیشتر
                                        انجام داده اید .</p>
                                    <button type="button" class="btn btn-primary mt-15">مشاهده
                                        فروش</button>
                                </div>
                                <div class="dashboard-content-left wow shake" data-wow-delay="0.6s">
                                    <img src="img/bg-img/5.jpg" class="img-fluid" alt="داشبورد"
                    ...
                    <div class="card">
                        <div class="card-body py-4">
                            <div class="media align-items-center">
                                ...
                                <div class="pirty-chart"><span class="bar">5،3،9،6،5،9،7،3،5،2</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="client-name">
                                <div class="row">
                                    <div class="col-sm-12 pt-2 pb-2">
                                        <span class="mr-3"><i
                                                class="feather icon-circle text-c-green  mr-2"></i>کیف پول
                                            اصلی </span>
                                        <span class="float-right text-muted">194.42 تومان</span>
                                    </div>
                                    <div class="col-sm-12 pt-2 pb-2">
                                        <span class="mr-3"><i
                                                class="feather icon-circle text-c-blue  mr-2"></i>سفر
                                        </span>
                                        <span class="float-right text-muted">194.42 تومان</span>
                                    </div>
                                    <div class="col-sm-12 pt-2">
                                        <span class="mr-3"><i
                                                class="feather icon-circle text-c-purple  mr-2"></i>غذا و
                                            نوشیدنی </span>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="media align-items-center">
                                                        <div class="chat-img mr-2">
                                                            <img src="img/shop-img/best-4.png"
                                                                alt="">
                                                        </div>
                                                        <div>
                                                            <span>تلفن تلفن</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media align-items-center">
                                                        <div class="chat-img mr-2">
                                                            <img src="img/shop-img/best-3.png"
                                                                alt="">
                                                        </div>
                                                        <div>
                                                            <span>ساعت مچی</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media align-items-center">
                                                        <div class="chat-img mr-2">
                                                            <img src="img/shop-img/best-2.png"
                                                                alt="">
                                                        </div>
                                                        <div>
                    ...
                    <div class="card bg-boxshadow full-height">
                        <div
                            ...
                            <ul class="nav total-earnings nav-tabs mb-0" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mr-0 active" id="month-users-tab"
                                        data-toggle="tab" href="#month-users" role="tab"
                                        aria-controls="month-users" aria-selected="true">ماه</a>
                                </li>
                            </ul>
                        </div>
                                        ...
                                        <div class="media">
                                            <div class="mr-3">
                                                ...
                                                <a href="#!"><img class="rounded-circle"
                                                        style="width:40px;" src="img/member-img/1.png"
                                                        alt="کاربر چت"></a>
                                            </div>
                                            <div class="media-body">
                                ...
                                <div class="col-12">
                                    <div class="single-widget-timeline">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="d-inline-block">لورم ایپسوم متن ساختگی </h6>
                                                <p class="mb-0">لورم ایپسوم متن ساختگی با تولید سادگی
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="chats" id="chatBox">
                                    <div class="chats">
                                        <div class="chat">
                                            ...
                                            <div class="chat-body">
                                                <div class="chat-content">
                                                    <p class="text-white">چطور میتوانیم کمک کنیم؟ ما برای
                                                        شما اینجا هستیم</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="chat chat-left">
                                            ...
                                            <div class="chat-body">
                                                <div class="chat-content">
                                                    <p>سلام جیکوب ، می توانید به من کمک کنید تا آن را
                                                        دریابم؟</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="chat">
                                            ...
                                            <div class="chat-body">
                                                <div class="chat-content">
                                                    <p class="text-white">Crest admin الگوی مدیریت پاسخگو
                                                        bootstrap 4 است.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <fieldset>
                                            <div class="input-group position-relative has-icon-left">
                                                <input type="text" class="form-control"
                                                    placeholder="پیام" aria-describedby="button-addon3">
                    ...
                    <div class="card">
                        <div class="card-body pb-0">
                            ...
                            <div class="row mb-3">
                                <div class="col-9">
                                    <div class="progress-wrapper">
                                        <span class="progress-label text-dark font-weight-bold">طراحی وب
                                            سایت</span>
                            ...
                            <div class="row mb-3">
                                <div class="col-9">
                                    <div class="progress-wrapper">
                                        <span class="progress-label text-dark font-weight-bold">نشانه
                                            گذاری وب سایت</span>
                                        <div class="progress mt-2 mb-2" style="height: 5px;">
                                            <div class="progress-bar bg-primary" role="progressbar"
                            ...
                            <div class="row mb-3">
                                <div class="col-9">
                                    <div class="progress-wrapper">
                                        <span class="progress-label text-dark font-weight-bold">یک
                                            صفحه</span>
                                        <div class="progress mt-2 mb-2" style="height: 5px;">
                                            <div class="progress-bar bg-primary" role="progressbar"
                            ...
                            <div class="row mb-3">
                                <div class="col-9">
                                    <div class="progress-wrapper">
                                        <span class="progress-label text-dark font-weight-bold">الگوی
                                            پاسخگو</span>
                                        <div class="progress mt-2 mb-2" style="height: 5px;">
                                            <div class="progress-bar bg-primary" role="progressbar"
                                                aria-valuenow="70" aria-valuemin="0"
                                                aria-valuemax="100" style="width: 570%;"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-3 align-self-end text-right">
                ...
                <div class="col-md-6 col-xl-4 height-card box-margin">
                    <div class="card">
                        <div class="card-body">
                            <div
                                class="bg-transparent d-flex align-items-center justify-content-between mb-20">
                                ...
                                <div class="dashboard-dropdown">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle" type="button"
                                            id="dashboardDropdown50" data-toggle="dropdown"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right"
                                            ...
                                            <a class="dropdown-item" href="#"><i
                                                    class="ti-pencil-alt"></i> ویرایش کنید</a>
                                            <a class="dropdown-item" href="#"><i
                                                    class="ti-settings"></i> تنظیمات</a>
                                            <a class="dropdown-item" href="#"><i
                                                    class="ti-eraser"></i> برداشتن</a>
                                            <a class="dropdown-item" href="#"><i
                            ...
                            <div
                                ...
                                <a href="#"
                                    class="download-link badge badge-info badge-pill">دانلود</a>
                            </div>
                            ...
                            <div
                                ...
                                <a href="#"
                                    class="download-link badge badge-success badge-pill">دانلود</a>
                            </div>

                            <!-- Single Download File -->
                            <div
                                class="widget-download-file d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center mr-3">
                                    <div class="download-file-icon mr-3">
                        ...
                        <div class="card-body pb-0">
                            <div
                                ...
                                <div class="dashboard-dropdown">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle" type="button"
                                            id="dashboardDropdown53" data-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false"><i
                                                class="ti-more"></i></button>
                                        <div class="dropdown-menu dropdown-menu-right"
                            ...
                            <div class="user-card-body">
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3"
                                        src="img/member-img/contact-1.jpg" alt="">
                                ...
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3"
                                        src="img/member-img/contact-2.jpg" alt="">
                                    <div class="user--media-body">
                                ...
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3"
                                        src="img/member-img/contact-3.jpg" alt="">
                                    <div class="user--media-body">
                                ...
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3"
                                        src="img/member-img/contact-4.jpg" alt="">
                                    <div class="user--media-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="#!"
                                                    class="badge badge-success badge-pill">فعال</a></td>
                                            <td class="text-right"><a href="#!"><i
                                                ...
                                                <a href="#!"><i
                                                        class="fa fa-star f-18 text-warning"></i></a>
                                                <a href="#!"><i
                                                        class="fa fa-star f-18 text-black-50"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td><a href="#!"
                                                    class="badge badge-danger badge-pill">غیر فعال</a>
                                            </td>
                                            <td class="text-right"><a href="#!"><i
                                                        class="fa fa-star f-18 text-warning"></i></a>
                                                <a href="#!"><i
